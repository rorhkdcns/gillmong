        ...
        <div className="mx-auto max-w-3xl">
          <div className="border border-gray-200 bg-white p-10 shadow-sm">
            ...
            <div className="space-y-10 text-[15px] leading-relaxed text-[#444]">
              ...
              <section>
                <h2 className="mb-3 text-lg font-bold text-[#0B2433]">제2조 (처리하는 개인정보 항목)</h2>
              ...
              <section>
                <h2 className="mb-3 text-lg font-bold text-[#0B2433]">제3조 (개인정보의 처리 및 보유 기간)</h2>
              ...
              <section>
                <h2 className="mb-3 text-lg font-bold text-[#0B2433]">제4조 (개인정보의 제3자 제공)</h2>
              ...
              <section>
                <h2 className="mb-3 text-lg font-bold text-[#0B2433]">제5조 (개인정보처리의 위탁)</h2>
              ...
              <section>
                <h2 className="mb-3 text-lg font-bold text-[#0B2433]">제6조 (정보주체의 권리·의무 및 행사방법)</h2>
              ...
              <section>
                <h2 className="mb-3 text-lg font-bold text-[#0B2433]">제7조 (개인정보의 파기)</h2>
              ...
              <section>
                <h2 className="mb-3 text-lg font-bold text-[#0B2433]">제8조 (개인정보 보호책임자)</h2>
              ...
              <section>
                <h2 className="mb-3 text-lg font-bold text-[#0B2433]">제9조 (권익침해 구제방법)</h2>
