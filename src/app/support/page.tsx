      ...
      <main className="flex-1 px-6 py-16">
        <div className="mx-auto max-w-3xl">
          <div className="mb-10 text-center">
            <h1 className="text-3xl font-black text-[#0B2433]">고객센터</h1>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#0B2433]/10">
                <svg className="h-6 w-6 text-[#0B2433]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
              </div>
              <h2 className="mb-2 text-lg font-bold text-[#0B2433]">이메일 문의</h2>
              ...
              <a
                ...
                className="inline-block rounded-xl bg-[#0B2433] px-5 py-2.5 text-sm font-semibold text-white hover:brightness-90 transition-all"
              >
                admin@gillmong.com
              </a>
            </div>
            ...
            {/* 운영시간 */}
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#14547A]/10">
                <svg className="h-6 w-6 text-[#14547A]" fill="none" stroke="currentColor" strokeWidth={1.8} viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h2 className="mb-2 text-lg font-bold text-[#0B2433]">운영시간</h2>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
              ...
              <h2 className="mb-2 text-lg font-bold text-[#0B2433]">1:1 문의</h2>
              <p className="mb-4 text-sm leading-relaxed text-[#555555]">
              ...
              <a
                href="/inquiry"
                className="inline-block rounded-xl border border-[#0B2433] px-5 py-2.5 text-sm font-semibold text-[#0B2433] hover:bg-[#0B2433] hover:text-white transition-colors"
              >
                문의하기
              </a>
            </div>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
              ...
              <h2 className="mb-2 text-lg font-bold text-[#0B2433]">자주 묻는 질문</h2>
              <p className="mb-4 text-sm leading-relaxed text-[#555555]">
              ...
              <a
                href="/faq"
                className="inline-block rounded-xl border border-gray-300 px-5 py-2.5 text-sm font-semibold text-[#555555] hover:border-[#0B2433] hover:text-[#0B2433] transition-colors"
              >
                FAQ 보기
              </a>
            </div>
          ...
          <div className="mt-8 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <h2 className="mb-4 text-base font-bold text-[#0B2433]">사업자 정보</h2>
