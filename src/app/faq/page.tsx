...
const FAQS = [
  {
    ...
    items: [
      {
        q: '길몽상점은 어떤 서비스인가요?',
        a: '길몽상점은 AI 해몽 분석 결과를 마켓에서 사고팔 수 있는 꿈 거래 플랫폼입니다. 꿈 내용을 입력하면 AI가 등급·해몽·행운번호를 분석하고, 그 결과를 카드/간편결제로 안전하게 거래할 수 있습니다.',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: '꿈은 어떻게 구매하나요?',
        a: '꿈 상세 페이지에서 구매 버튼을 누르면 카드·간편결제(NicePay)로 직접 결제할 수 있습니다. 결제 완료 즉시 해몽 전문이 열람됩니다.',
      },
      {
        q: '꿈 판매 수익은 어떻게 받나요?',
        a: '구매자가 7일 이내에 구매확정 버튼을 누르거나, 결제 후 7일이 경과하면 판매가의 80%가 자동으로 정산됩니다(플랫폼 수수료 20%). 정산된 금액은 마이페이지 → 출금 신청을 통해 현금으로 받을 수 있습니다.',
      },
      {
        q: '구매한 꿈은 환불이 가능한가요?',
        a: '결제 후 7일 이내에 마이페이지 → 결제 주문 내역 → 환불요청을 통해 환불을 신청할 수 있습니다. 관리자 검토 후 처리되며, 승인 시 전액 환불됩니다.',
      },
      {
        q: '기존에 충전한 포인트 잔액은 어떻게 되나요?',
        a: '포인트 충전 서비스는 종료되었지만, 기존에 보유하신 포인트 잔액은 꿈 구매 시 계속 사용 가능합니다. 잔액은 마이페이지에서 확인할 수 있으며, 회원 탈퇴 시 소멸되어 환급되지 않습니다.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        a: '최소 5,000원이며, 100원 단위로 설정하실 수 있습니다.',
      },
      {
        q: '등록한 꿈을 삭제할 수 있나요?',
      ...
      },
      {
        ...
        a: '개인 저장은 분석 결과를 나만 볼 수 있도록 비공개로 보관하는 기능입니다. 마켓 등록은 다른 사용자가 결제하고 구매할 수 있도록 공개 판매하는 것입니다.',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        q: '회원 탈퇴는 어떻게 하나요?',
        a: '마이페이지 하단 "탈퇴하기"를 통해 탈퇴 신청을 할 수 있습니다. 탈퇴 시 등록된 꿈, 잔여 포인트, 구매 내역 등 모든 데이터가 삭제되며 복구할 수 없습니다.',
      },
    ],
  },
]
