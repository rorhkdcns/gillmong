    ...
    <div className="flex min-h-screen flex-col bg-brand-page">
      ...
      <footer className="border-t border-gray-200 bg-white px-6 py-10 text-[13px]">
        <div className="mx-auto max-w-6xl">
          ...
          {/* 링크 한 줄 */}
          <div className="flex flex-wrap gap-x-5 gap-y-2 text-sm text-[#555555]">
            {[
          ...
          <div className="mt-8 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
            ...
            {/* 우측: 사업자 정보 + 카피라이트 */}
            <div className="flex flex-col gap-1 text-right text-xs text-[#888888]">
