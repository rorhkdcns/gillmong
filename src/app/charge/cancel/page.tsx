  ...
  return (
    <>
      ...
      <main className="flex min-h-[70vh] flex-col items-center justify-center px-4 py-12 text-center">
        ...
        <h1 className="mb-3 text-2xl font-bold text-[#0B2433]">결제에 실패했습니다</h1>
        <p className="mb-1 text-sm text-gray-500">결제가 취소되었거나 오류가 발생했습니다.</p>
        <p className="mb-10 text-sm text-gray-400">잠시 후 다시 시도해주세요.</p>

        <Link
          href="/charge"
          className="mb-3 inline-block rounded-xl bg-[#14547A] px-10 py-3 font-bold text-white hover:brightness-95"
        >
          다시 충전하기
        </Link>
        <Link
          href="/mypage"
          className="mb-3 inline-block rounded-xl border border-[#0B2433] px-10 py-3 font-bold text-[#0B2433] hover:bg-[#0B2433] hover:text-white transition"
        >
          마이페이지로 돌아가기
        </Link>
